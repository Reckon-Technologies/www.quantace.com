...
try {
  ...
  console.warn("✅ loaded root .env.local file:");
} catch (error) {
        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' http://localhost:3001 http://localhost:9999 https://localhost:3001 https://accounts.google.com https://play.google.com https://apis.google.com",
